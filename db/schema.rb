...
ActiveRecord::Schema.define(version: 20_181_014_150_549) do
  ...
  add_index 'promotions', %w[user_id promo_id], name: 'index_promotions_on_user_id_and_promo_id', unique: true, using: :btree
